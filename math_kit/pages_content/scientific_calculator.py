...
class Calculator:
    def __init__(self, master):
        ...
        top_frame = tk.Frame(master, width=650, height=20,
                             bd=4, relief='flat', bg='#666666')
        top_frame.pack(side=tk.TOP)
        # set frame showing all buttons
        bottom_frame = tk.Frame(
            master, width=650, height=470, bd=4, relief='flat', bg='#666666')
        ...
        # cubes a value
        self.cube = tk.Button(bottom_frame, **btn_params,
        ...
        # seven
        self.btn_7 = tk.Button(bottom_frame, **btn_params,
        ...
        # eight
        self.btn_8 = tk.Button(bottom_frame, **btn_params,
        ...
        # nine
        self.btn_9 = tk.Button(bottom_frame, **btn_params,
        ...
        self.btn_tan = tk.Button(
            bottom_frame, **btn_params, text="tan", command=lambda: self.btn_click('ftan('))
        ...
        # four
        self.btn_4 = tk.Button(bottom_frame, **btn_params,
        ...
        # five
        self.btn_5 = tk.Button(bottom_frame, **btn_params,
        ...
        # six
        self.btn_6 = tk.Button(bottom_frame, **btn_params,
        ...
        self.btn_ln = tk.Button(
            bottom_frame, **btn_params, text="ln", command=lambda: self.btn_click('log1p('))
        self.btn_ln.grid(row=3, column=3)
        # one
        self.btn_1 = tk.Button(bottom_frame, **btn_params,
        ...
        # two
        self.btn_2 = tk.Button(bottom_frame, **btn_params,
        ...
        # three
        self.btn_3 = tk.Button(bottom_frame, **btn_params,
        ...
        self.btn_fact = tk.Button(
            bottom_frame, **btn_params, text="n!", command=lambda: self.btn_click('factorial('))
        self.btn_fact.grid(row=4, column=0)
        # square function
        self.btn_sqr = tk.Button(
            bottom_frame, **btn_params, text=u"x\u00B2", command=lambda: self.btn_click('**2'))
        ...
        # zero
        self.btn_0 = tk.Button(bottom_frame, **btn_params,
                               text="0", command=lambda: self.btn_click(0))
        self.btn_0.configure(activebackground="#4d4d4d",
                             bg='#4d4d4d', width=7, bd=5)
    ...
    def btn_click(self, expression_val):
        """
        This function takes the value of the button you click and puts it into self.expression
        """
    ...
    def btn_clear1(self):
        """
        This function clears the last item in the string
        """
    ...
    def change_signs(self):
        """
        This function changes the signs of the numbers in the string
        """
        self.expression = self.expression + '-'
        self.text_input.set(self.expression)
